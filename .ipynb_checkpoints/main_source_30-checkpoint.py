...
def main_worker(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch<args.epochs//3:
            train_source(source_loaders["train_label"], net_f, net_b, net_c, criterion, optimizer, epoch, args, writer)
        else:
            train_source(source_loaders["train_unlabel"], net_f, net_b, net_c, criterion, optimizer, epoch, args, writer,label_flag=False)
